<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inscription.aspx.cs" Inherits="Serie_4_Atelier_2.Inscription" %>
...
<body>
    <form id="formInscription" runat="server">
        <div id="container">
            <h1 style="margin:0; font-size:2.5rem; color: aliceblue; text-align: center ">Page d'inscription des Membres</h1>
            <br />
